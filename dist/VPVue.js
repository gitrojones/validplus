(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("ValidPlus"));
	else if(typeof define === 'function' && define.amd)
		define(["ValidPlus"], factory);
	else if(typeof exports === 'object')
		exports["VPVue"] = factory(require("ValidPlus"));
	else
		root["VPVue"] = factory(root["ValidPlus"]);
})(window, function(__WEBPACK_EXTERNAL_MODULE_ValidPlus__) {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var core_js_modules_es6_array_iterator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es6.array.iterator */ \"./node_modules/core-js/modules/es6.array.iterator.js\");\n/* harmony import */ var core_js_modules_es6_array_iterator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es6_array_iterator__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var core_js_modules_es6_object_keys__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/es6.object.keys */ \"./node_modules/core-js/modules/es6.object.keys.js\");\n/* harmony import */ var core_js_modules_es6_object_keys__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es6_object_keys__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var core_js_modules_web_dom_iterable__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! core-js/modules/web.dom.iterable */ \"./node_modules/core-js/modules/web.dom.iterable.js\");\n/* harmony import */ var core_js_modules_web_dom_iterable__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_iterable__WEBPACK_IMPORTED_MODULE_2__);\n/* harmony import */ var _Validatable__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Validatable */ \"./src/vue/Validatable.js\");\n\n\n\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ({\n  props: {\n    VPStrategy: [Function, String],\n    VPOptions: Object,\n    VPValid: Object,\n    VPFields: {\n      type: Array,\n      default: function _default() {\n        return [];\n      }\n    }\n  },\n  mixins: [_Validatable__WEBPACK_IMPORTED_MODULE_3__[\"default\"]],\n  mounted: function mounted() {\n    this.VPFieldset = this.VPCreateFieldset(this.$el, 'all', this.VPOptions, this.VPFields, this.VPValid);\n    this.VPGatherFields();\n  },\n  data: function data() {\n    return {\n      VPFieldset: null\n    };\n  },\n  methods: {\n    VPGatherFields: function VPGatherFields() {\n      var _this = this;\n\n      Object.keys(this.$slots).forEach(function (slot) {\n        var data = _this.$slots[slot];\n        data.forEach(function (field) {\n          if (field._isVue) {\n            field.$once('VPAddField', function (field) {\n              _this.VPFieldset.addField(field);\n            });\n          }\n        });\n      });\n      this.$children.forEach(function (field) {\n        if (field._isVue) {\n          field.$once('VPAddField', function (field) {\n            _this.VPFieldset.addField(field);\n          });\n        }\n      });\n    }\n  }\n});\n\n//# sourceURL=webpack://%5Bname%5D/./src/vue/Fieldset.js?");

/***/ }),

/***/ "./src/vue/Validatable.js":
/*!********************************!*\
  !*** ./src/vue/Validatable.js ***!
  \********************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* WEBPACK VAR INJECTION */(function(process) {/* harmony import */ var core_js_modules_web_dom_iterable__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/web.dom.iterable */ \"./node_modules/core-js/modules/web.dom.iterable.js\");\n/* harmony import */ var core_js_modules_web_dom_iterable__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_iterable__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var ValidPlus__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ValidPlus */ \"ValidPlus\");\n/* harmony import */ var ValidPlus__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(ValidPlus__WEBPACK_IMPORTED_MODULE_1__);\n\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ({\n  props: {\n    validator: {\n      type: Object,\n      default: function _default() {\n        if (this.VPNewValidator) {\n          this.VPProvideValidator = true;\n        }\n\n        return this.VPValidator;\n      }\n    }\n  },\n  provide: function provide() {\n    if (this.VPProvideValidator) {\n      return {\n        VPValidator: this.validator\n      };\n    }\n  },\n  inject: {\n    VPValidator: {\n      default: function _default() {\n        console.log('[VPVue] Validator not provided, injecting new validator.');\n        this.VPNewValidator = true; // SSR Support\n\n        if (process.env.VUE_ENV !== 'server') {\n          var _VP = __webpack_require__(/*! ValidPlus */ \"ValidPlus\").default;\n\n          return new _VP.Validator({});\n        } else {\n          return null;\n        }\n      }\n    }\n  },\n  methods: {\n    VPCreateField: function VPCreateField(el, options, rules, onValidation) {\n      return new ValidPlus__WEBPACK_IMPORTED_MODULE_1___default.a.Field(el, options, rules, onValidation);\n    },\n    VPCreateFieldset: function VPCreateFieldset(el, strategy, options, fields, onvalidation) {\n      var fieldset = this.validator.createFieldset(el, strategy, options, fields, onvalidation);\n      this.VPFieldSets.push(fieldset);\n      return fieldset;\n    },\n    VPisValid: function VPisValid() {\n      if (this.validator.isValid()) {\n        this.$emit('isValid');\n        return true;\n      }\n\n      return false;\n    }\n  },\n  beforeDestroy: function beforeDestroy() {\n    var _this = this;\n\n    this.VPFieldSets.forEach(function (fs) {\n      console.log('[VPVue] Cleaning up fieldsets', fs);\n\n      _this.validator.removeFieldset(fs);\n    });\n  },\n  data: function data() {\n    return {\n      VPFieldSets: []\n    };\n  }\n});\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../../node_modules/process/browser.js */ \"./node_modules/process/browser.js\")))\n\n//# sourceURL=webpack://%5Bname%5D/./src/vue/Validatable.js?");
...
eval("module.exports = __WEBPACK_EXTERNAL_MODULE_ValidPlus__;\n\n//# sourceURL=webpack://%5Bname%5D/external_%22ValidPlus%22?");
