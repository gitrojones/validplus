...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _prepend__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./prepend */ \"./lib/polyfills/prepend.js\");\n/* harmony import */ var _arrayFrom__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./arrayFrom */ \"./lib/polyfills/arrayFrom.js\");\n/* harmony import */ var _nodeListForEach__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./nodeListForEach */ \"./lib/polyfills/nodeListForEach.js\");\n\n\n\n\n//# sourceURL=webpack://%5Bname%5D/./lib/polyfills/index.js?");

/***/ }),

/***/ "./lib/polyfills/nodeListForEach.js":
/*!******************************************!*\
  !*** ./lib/polyfills/nodeListForEach.js ***!
  \******************************************/
/*! no exports provided */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var core_js_modules_web_dom_iterable__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/web.dom.iterable */ \"./node_modules/core-js/modules/web.dom.iterable.js\");\n/* harmony import */ var core_js_modules_web_dom_iterable__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_iterable__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _Fieldset__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Fieldset */ \"./src/Fieldset.js\");\n/* harmony import */ var _util_debug__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./util/debug */ \"./src/util/debug.js\");\n/* harmony import */ var _util_mergeDeep__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./util/mergeDeep */ \"./src/util/mergeDeep.js\");\n/* harmony import */ var _util_isElemVisible__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./util/isElemVisible */ \"./src/util/isElemVisible.js\");\n/* harmony import */ var _lib_events__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./lib/events */ \"./src/lib/events.js\");\n/* harmony import */ var _lib_messaging__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./lib/messaging */ \"./src/lib/messaging.js\");\n\n\n\n\n\n\n\n/**\n  * ValidPlus Validator instance, the container\n  * responsible for firing off the validation cycle\n  *\n  * @name VPValidator\n  * @param {object} VPValidationOptions - Options for Validation\n  */\n\nvar Validator = function Validator(options) {\n  var form = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;\n\n  if (form === null) {\n    Object(_util_debug__WEBPACK_IMPORTED_MODULE_2__[\"default\"])('[Validator] Non-strict fieldset matching.', 'Provide a form Element or ID to enable strict matching.');\n    this._form = null;\n    this._strict = false; // Fieldsets being tracked by Validator\n\n    this._fieldsets = [];\n  } else {\n    this._form = ElementOrID(form); // TODO: Add strict support (can only add elements contained within the field)\n\n    this._strict = true; // TODO: Add child detection\n\n    this._fieldsets = []; // GetChildFieldsets\n  }\n\n  this.listeners = {}; // Conform to the child interfaces for messaging\n\n  this.element = this._form;\n  this.options = Object(_util_mergeDeep__WEBPACK_IMPORTED_MODULE_3__[\"default\"])({\n    validateVisible: true,\n    fieldsetClass: 'VPFieldset',\n    errorClass: '-isError',\n    validClass: '-isValid',\n    messageAnchor: null,\n    messagePOS: 'bottom',\n    lazy: true,\n    watch: false,\n    scrollAnchor: null,\n    scrollTo: true\n  }, options);\n  this.validationInputs = ['input', 'messagebox', 'select'];\n\n  if (Array.isArray(options.validationInputs)) {\n    this._options.validationInputs = this._options.validationInputs.concat(options.valiationInputs);\n  } // TODO: Validate options\n  // TODO: Allow toggling options on whether to show messages or fire callbacks\n\n\n  this._onValidation = Object(_util_mergeDeep__WEBPACK_IMPORTED_MODULE_3__[\"default\"])({\n    isValid: {\n      cb: null,\n      message: null\n    },\n    isInvalid: {\n      cb: null,\n      message: null\n    }\n  }, options.onValidation);\n  this._isValid = null;\n  this._messageNode = null;\n  this._messages = [];\n  this._strategies = {\n    'all': function all(fields) {\n      return fields.every(function (field) {\n        return field === true;\n      });\n    },\n    'some': function some(fields) {\n      return fields.some(function (field) {\n        return field === true;\n      });\n    },\n    'one': function one(fields) {\n      return fields.filter(function (field) {\n        return field === true;\n      }).length === 1;\n    }\n  };\n};\n\nValidator.prototype.isValid = function () {\n  var _this = this;\n\n  if (this.options.lazy) {\n    this._isValid = this._fieldsets.every(function (fieldset) {\n      if (_this.options.validateVisible) {\n        if (Object(_util_isElemVisible__WEBPACK_IMPORTED_MODULE_4__[\"default\"])(fieldset.element)) {\n          Object(_util_debug__WEBPACK_IMPORTED_MODULE_2__[\"default\"])('[VPValidator] Fieldset is visible, continuing');\n          return fieldset.isValid();\n        } else {\n          Object(_util_debug__WEBPACK_IMPORTED_MODULE_2__[\"default\"])('[VPValidator] Skipping hidden fieldset', fieldset);\n        }\n      } else {\n        return fieldset.isValid();\n      }\n    });\n  } else {\n    this._isValid = this._fieldsets.reduce(function (isValid, fieldset) {\n      if (_this.options.validateVisible) {\n        if (Object(_util_isElemVisible__WEBPACK_IMPORTED_MODULE_4__[\"default\"])(fieldset.element)) {\n          if (!fieldset.isValid()) {\n            isValid = false;\n          } else {\n            Object(_util_debug__WEBPACK_IMPORTED_MODULE_2__[\"default\"])('[VPValidator] Skipping hidden fieldset', fieldset);\n          }\n        }\n      } else {\n        if (!fieldset.isValid()) {\n          isValid = false;\n        }\n      }\n\n      return isValid;\n    }, true);\n  }\n\n  if (this._isValid) {\n    if (this.element instanceof Element) {\n      this.element.classList.remove(this.options.errorClass);\n      this.element.classList.add(this.options.validClass);\n    }\n\n    if (typeof this._onValidation.isValid.cb === 'function') {\n      this._onValidation.isValid.cb();\n    }\n\n    if (typeof this._onValidation.isValid.message === 'string') {\n      this.addMessage(this._onValidation.isValid.message, this.options.validClass);\n    }\n  } else {\n    if (this.element instanceof Element) {\n      this.element.classList.remove(this.options.validClass);\n      this.element.classList.add(this.options.errorClass);\n    }\n\n    if (this.options.scrollTo === true) {\n      var scrollElement;\n\n      if (this.options.scrollAnchor instanceof Element) {\n        scrollElement = this.options.scrollAnchor;\n      } else {\n        var firstElement = this._fieldsets.filter(function (f) {\n          return f._isValid === false;\n        })[0];\n\n        scrollElement = firstElement.element;\n      }\n\n      if (typeof scrollElement.scrollIntoView === 'function') {\n        scrollElement.scrollIntoView();\n      } else {\n        Object(_util_debug__WEBPACK_IMPORTED_MODULE_2__[\"default\"])('[VP] Element Scrolling failed.');\n      }\n    }\n\n    if (typeof this._onValidation.isInvalid.cb === 'function') {\n      this._onValidation.isInvalid.cb();\n    }\n\n    if (typeof this._onValidation.isInvalid.message === 'string') {\n      this.addMessage(this._onValidation.isInvalid.message, this.options.errorClass);\n    }\n  }\n\n  return this._isValid;\n}; // TODO: Child state checks\n// TODO: Add MutationObserver on children\n\n\nValidator.prototype.addFieldset = function (fieldset) {\n  if (!(fieldset instanceof _Fieldset__WEBPACK_IMPORTED_MODULE_1__[\"default\"])) {\n    throw new Error('[Validator] Fieldset must be an instanceof VPFieldset');\n  }\n\n  this._fieldsets.push(fieldset);\n\n  if (this.options.watch === true) {\n    this.watchFieldset(_fieldset);\n  }\n}; // TODO: method to remove watchers\n\n\nValidator.prototype.watchFieldset = function (fieldset) {\n  var _this2 = this;\n\n  if (!(fieldset instanceof _Fieldset__WEBPACK_IMPORTED_MODULE_1__[\"default\"])) return; // TODO: Optimize by tracking state and only revalidating\n  // if internal state changes. Currently wasteful\n\n  fieldset.addEventListener('onValidate', function (e, isValid) {\n    var emit = _this2._isValid !== null;\n\n    _this2.isValid();\n  });\n}; // TODO: Remove MutationObserver on children\n\n\nValidator.prototype.removeFieldset = function (fieldset) {\n  var index = this._fieldsets.indexOf(fieldset);\n\n  if (index !== -1) {\n    this._fieldsets = this._fieldsets.splice(index, 1);\n  }\n}; // TODO: Append Predefined Fields w/ CB logic\n// TODO: Validate onValidate structure\n// TODO: Add MutationObserver on children\n\n\nValidator.prototype.createFieldset = function (fs, strategy, options, fields) {\n  var onValidate = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : null;\n  var fieldset = ElementOrID(fs, this._form);\n\n  if (fieldset === null) {\n    Object(_util_debug__WEBPACK_IMPORTED_MODULE_2__[\"default\"])('[Validator] Requires a valid fieldset HTMLElement.');\n    return false;\n  }\n\n  var _strategy = this._strategies[strategy] || function () {\n    throw new Error('[Validator] Invalid Validation Strategy');\n  };\n\n  var _fieldset = new _Fieldset__WEBPACK_IMPORTED_MODULE_1__[\"default\"](fieldset, _strategy, options, onValidate);\n\n  fields.forEach(function (field) {\n    _fieldset.addField(field);\n  });\n\n  this._fieldsets.push(_fieldset);\n\n  if (this.options.watch === true) {\n    this.watchFieldset(_fieldset);\n  }\n\n  return _fieldset;\n}; // EventTarget\n\n\nValidator.prototype.listeners = null;\nValidator.prototype.addEventListener = _lib_events__WEBPACK_IMPORTED_MODULE_5__[\"default\"].addEventListener;\nValidator.prototype.removeEventListener = _lib_events__WEBPACK_IMPORTED_MODULE_5__[\"default\"].removeEventListener;\nValidator.prototype.dispatchEvent = _lib_events__WEBPACK_IMPORTED_MODULE_5__[\"default\"].dispatchEvent; // DOM Messaging\n\nValidator.prototype.clearMessages = _lib_messaging__WEBPACK_IMPORTED_MODULE_6__[\"default\"].clearMessages;\nValidator.prototype.removeMessage = _lib_messaging__WEBPACK_IMPORTED_MODULE_6__[\"default\"].removeMessage;\nValidator.prototype.addMessage = _lib_messaging__WEBPACK_IMPORTED_MODULE_6__[\"default\"].addMessage('VPMessage'); // TODO: Strict enforcement\n\nvar ElementOrID = function ElementOrID(ElorID) {\n  var form = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;\n  if (ElorID instanceof Element) return ElorID;\n\n  if (typeof ElorID === 'string') {\n    var f = form !== null && form instanceof Element ? form.getElemenyById(ElorID) : window.document.getElementById(ElorID);\n    if (f instanceof Element) return f;\n  }\n\n  return null;\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (Validator);\n\n//# sourceURL=webpack://%5Bname%5D/./src/Validator.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony default export */ __webpack_exports__[\"default\"] = (function (event_type) {\n  var event;\n\n  if (typeof Event === 'function') {\n    event = new Event(event_type);\n  } else {\n    event = document.createEvent('Event');\n    event.initEvent(event_type, true, true);\n  }\n\n  return event;\n});\n\n//# sourceURL=webpack://%5Bname%5D/./src/util/createEvent.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony default export */ __webpack_exports__[\"default\"] = ( true ? function () {\n  var _console;\n\n  for (var _len = arguments.length, msg = new Array(_len), _key = 0; _key < _len; _key++) {\n    msg[_key] = arguments[_key];\n  }\n\n  return (_console = console).log.apply(_console, ['[Debug]'].concat(msg));\n} : undefined);\n\n//# sourceURL=webpack://%5Bname%5D/./src/util/debug.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony default export */ __webpack_exports__[\"default\"] = (function (message, className) {\n  var el = document.createElement('div');\n  el.className = className;\n  el.innerHTML = message;\n  return el;\n});\n\n//# sourceURL=webpack://%5Bname%5D/./src/util/generateElement.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n// JQuery $(element).is(':visible')\n/* harmony default export */ __webpack_exports__[\"default\"] = (function (element) {\n  if (element instanceof Element) {\n    return !!(element.offsetWidth || element.offsetHeight || element.getClientRects().length);\n  } else {\n    return null;\n  }\n});\n\n//# sourceURL=webpack://%5Bname%5D/./src/util/isElemVisible.js?");
